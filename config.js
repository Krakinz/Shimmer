...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Shimmer;Krakinz;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,254,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Shimmer",
    BOT_NAME: process.env.BOT_NAME || 'Shimmer',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢ Krakinz ꫂ;Shimmer MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
